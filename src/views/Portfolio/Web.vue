    ...
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      ...
      >
        ...
        <v-card v-if="project.dialog">
          <v-img aspect-ratio="1.7" contain  :src="project.poster"></v-img>
          <v-card-text>
  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "Abbas Məmiyev's Web Portfolio Vue Vue.js Nuxt Nuxt.js HTML CSS Vuetify Axios GraphQL JavaScript Web Developer Front-End Frontend Designer App Responsive"
      },
      { charset: "utf-8" },
      ...
      projects: [
         {
          dialog: false,
          title: "Traveller",
          git: "https://github.com/Vahidoghlu/vahidoghlu.github.io",
          demo: "https://vahidoghlu.github.io/",
          tech: {
            tech1: "JavaScript",
            tech2: "HTML",
            tech3: "CSS",
          ...
          poster: "https://i.imgur.com/tDv0OR8.png",
        },
      ]
    };
  }
